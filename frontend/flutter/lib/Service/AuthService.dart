...
class AuthService {
  ...
  static Future<String> register(
    ...
    var response = await http.post(Uri.parse('$url$controller/register'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode(
